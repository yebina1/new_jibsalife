...
const placeHospitals: HospitalCardItem[] = [
  {
    name: '행복 동물병원',
...
function Place() {
  ...
  const sortedHospitals = sortHospitalsByStatusAndDistance(placeHospitals, (hospital) => ({
  ...
  const toggleLike = (name: string) => {
    setLikedNames((prev) => {
      ...
      showStateBarMessage(isLiked ? '찜한 장소에서 제거했어요.' : '찜한 장소에 추가했어요.', 3000, {
        placement: 'footer',
      })
